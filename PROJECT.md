...
The AXON project entry points are integrated through PR #44. `INTENT.md` now owns enduring product purpose and boundaries; `CONTEXT.md` owns project authority, architecture and domain-language routing. README and runtime instructions link to them without carrying live delivery state.
